...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react45.useState)([]);
  const timeoutRef = (0, import_react45.useRef)();
  const flush = () => {
  ...
  (0, import_react45.useEffect)(() => flush, []);
...
var useSafeLayoutEffect3 = isBrowser ? import_react46.useLayoutEffect : import_react46.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-TFWETJDV.mjs
var import_react47 = __toESM(require_react(), 1);
function useCallbackRef2(fn2, deps = []) {
  const ref = (0, import_react47.useRef)(fn2);
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react49.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react54.useRef)();
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react57.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react58.useState)(null);
  const ref = (0, import_react58.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react59.useCallback)(
    (next) => {
...
function useEventListenerMap() {
  ...
  const add = (0, import_react61.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react61.useCallback)(
...
function useFocusOnShow(target, options = defaultOptions) {
  ...
  const autoFocusRef = (0, import_react63.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react63.useRef)(visible);
  useSafeLayoutEffect3(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react65.useState)(isOpen);
  const [once, setOnce] = (0, import_react65.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react66.useState)(initialState2);
  const callbacks = (0, import_react66.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(initialValue, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react67.useState)(false);
  const [value, setValue] = (0, import_react67.useState)(initialValue);
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react69.useState)(null);
  const rafId = (0, import_react69.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react70.cloneElement)(child, theming) : (0, import_react70.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const childrenToRender = (0, import_react71.useMemo)(
    () => shouldWrapChildren ? import_react71.Children.map(children, (child, index) => (0, import_jsx_runtime69.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react72.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      return (0, import_jsx_runtime71.jsxs)(import_react72.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react73.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime78.jsx)(import_jsx_runtime78.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime78.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime78.jsx)(import_react73.Fragment, { children: chunk.text }, index);
  }) });
}
